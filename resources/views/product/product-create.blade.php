<x-guest-layout>
    <section class="">
        <form class="self-center" action="{{route('products.create')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mt-4">
                ...
                <img class=" w-full object-cover" id="downloaded" src="" alt=""/>
                <x-input-error :messages="$errors->get('image')" class="mt-2"/>
            </div>

            <div class="mt-4">
                <x-input-label for="product_name" :value="__('Название')"/>
                <x-text-input class="block mt-1 w-full" type="text" name="product_name" :value="old('product_name')"
                              required/>
            ...
            <div class="mt-4">
                ...
                <x-text-input class="block mt-1 w-full" type="number" name="price" :value="old('price')" min="0"
                              step="0.01"
                              required/>
            ...
            <div class="mt-4">
                ...
                <x-text-input class="block mt-1 w-full" type="text" name="age_group" :value="old('age_group')"
                              required/>
